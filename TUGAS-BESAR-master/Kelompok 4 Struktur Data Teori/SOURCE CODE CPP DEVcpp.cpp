...
{
		gotoxy(3,3);
		cout<<"************** Selamat Datang di Bank TI-B ***************"<<endl;
		gotoxy(3,4);
	...
	do{
		...
		switch(pil)
		{
			...
			case 6 :
				...
				gotoxy(3,4);
				cout<<"************ Universitas Teknologi Yogyakarta ************"<<endl;
				gotoxy(7,7);cout<<"Aplikasi ini dibuat untuk memenuhi tugas struktur data\n";
				gotoxy(7,9);cout<<"                      Kelompok 4";
				gotoxy(7,11);cout<<"\tHari Nugraha 5160411129, \n\tMuhammad Daris 5160411074, \n\tFebri 5160411110, \n\tRitvan 516041116";
